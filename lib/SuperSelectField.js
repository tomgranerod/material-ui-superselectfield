...
var SelectionsPresenter = function SelectionsPresenter(_ref5) {
  ...
  var floatingLabelColor = 'rgba(0, 0, 0, 0.3)';
  var borderColor = '#e0e0e0';
  var focusColor = '#00bcd4';
...
var SelectField = function (_Component2) {
  ...
  _createClass(SelectField, [{
    ...
    value: function render() {
      ...
      var selectedTextColor = '#ff4081';
      var menuHoverColor = 'rgb(0, 0, 0, 0.1)';
      ...
      var mergedHoverColor = hoverColor || menuHoverColor;
      ...
      var menuItemBuilder = function menuItemBuilder(nodes, child, index) {
        ...
        return [].concat(_toConsumableArray(nodes), [_react2.default.createElement(
          _List.ListItem,
          {
            key: ++index,
            tabIndex: index,
...
exports.default = (0, _withTheme2.default)()(SelectField);
